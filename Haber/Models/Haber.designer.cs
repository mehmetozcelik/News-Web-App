...
namespace Haber.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="Haber")]
	public partial class HaberDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertAnaKategori(AnaKategori instance);
    partial void UpdateAnaKategori(AnaKategori instance);
    partial void DeleteAnaKategori(AnaKategori instance);
    ...
    partial void InsertHaber(Haber instance);
    partial void UpdateHaber(Haber instance);
    partial void DeleteHaber(Haber instance);
    partial void Insertaspnet_Membership(aspnet_Membership instance);
    partial void Updateaspnet_Membership(aspnet_Membership instance);
    partial void Deleteaspnet_Membership(aspnet_Membership instance);
    #endregion
		
		public HaberDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["HaberConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public HaberDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HaberDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HaberDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HaberDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<AltKategori> AltKategoris
		{
			get
			{
		...
		public System.Data.Linq.Table<AnaKategori> AnaKategoris
		{
			get
			{
				return this.GetTable<AnaKategori>();
			}
		}
		...
		public System.Data.Linq.Table<Haber> Habers
		{
			get
			{
				return this.GetTable<Haber>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AltKategori")]
	public partial class AltKategori : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Haber> _Habers;
		
		private EntityRef<AnaKategori> _AnaKategori;
    ...
    partial void OnAnaKategoriIDChanged();
		...
		public AltKategori()
		{
			this._Habers = new EntitySet<Haber>(new Action<Haber>(this.attach_Habers), new Action<Haber>(this.detach_Habers));
			this._AnaKategori = default(EntityRef<AnaKategori>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Adi", DbType="NVarChar(100)")]
		public string Adi
		{
			get
			{
		...
		public System.Nullable<int> AnaKategoriID
		{
			...
			set
			{
				...
				{
					if (this._AnaKategori.HasLoadedOrAssignedValue)
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AltKategori_Haber", Storage="_Habers", ThisKey="id", OtherKey="KategoriID")]
		public EntitySet<Haber> Habers
		{
			get
			{
				return this._Habers;
			...
			set
			{
				this._Habers.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AnaKategori_AltKategori", Storage="_AnaKategori", ThisKey="AnaKategoriID", OtherKey="id", IsForeignKey=true)]
		public AnaKategori AnaKategori
		{
			get
			{
				return this._AnaKategori.Entity;
			}
			set
			{
				AnaKategori previousValue = this._AnaKategori.Entity;
				if (((previousValue != value) 
							|| (this._AnaKategori.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._AnaKategori.Entity = null;
						previousValue.AltKategoris.Remove(this);
					}
					this._AnaKategori.Entity = value;
					if ((value != null))
					{
						value.AltKategoris.Add(this);
						this._AnaKategoriID = value.id;
					}
					else
					{
						this._AnaKategoriID = default(Nullable<int>);
					}
					this.SendPropertyChanged("AnaKategori");
				}
			}
		}
		...
		private void attach_Habers(Haber entity)
		{
			this.SendPropertyChanging();
			entity.AltKategori = this;
		}
		
		private void detach_Habers(Haber entity)
		{
			this.SendPropertyChanging();
			entity.AltKategori = null;
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AnaKategori")]
	public partial class AnaKategori : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnRenkChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Renk", DbType="NVarChar(50)")]
		public string Renk
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AnaKategori_AltKategori", Storage="_AltKategoris", ThisKey="id", OtherKey="AnaKategoriID")]
	...
	public partial class Yorum : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Haber> _Haber;
    ...
    partial void OnHaberIDChanged();
		...
		public Yorum()
		{
			this._Haber = default(EntityRef<Haber>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Icerik", DbType="NVarChar(2000)")]
		...
		public System.Nullable<int> HaberID
		{
			...
			set
			{
				...
				{
					if (this._Haber.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Haber_Yorum", Storage="_Haber", ThisKey="HaberID", OtherKey="id", IsForeignKey=true)]
		public Haber Haber
		{
			get
			{
				return this._Haber.Entity;
			}
			set
			{
				Haber previousValue = this._Haber.Entity;
				if (((previousValue != value) 
							|| (this._Haber.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Haber.Entity = null;
						previousValue.Yorums.Remove(this);
					}
					this._Haber.Entity = value;
					if ((value != null))
					{
						value.Yorums.Add(this);
						this._HaberID = value.id;
					}
					else
					{
    ...
    partial void OnAciklamaChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Resim_Haber", Storage="_Habers", ThisKey="id", OtherKey="ResımID")]
		public EntitySet<Haber> Habers
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Haber")]
	public partial class Haber : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _ResımID;
		
		private EntitySet<Yorum> _Yorums;
		
		private EntityRef<AltKategori> _AltKategori;
		
		private EntityRef<Resim> _Resim;
    ...
    partial void OnKisaAciklamaChanging(string value);
    partial void OnKisaAciklamaChanged();
    partial void OnIcerikChanging(string value);
    partial void OnIcerikChanged();
    partial void OnEklenmeTarihiChanging(System.Nullable<System.DateTime> value);
    partial void OnEklenmeTarihiChanged();
    ...
    partial void OnResımIDChanging(System.Nullable<int> value);
    partial void OnResımIDChanged();
    #endregion
		
		public Haber()
		{
			this._Yorums = new EntitySet<Yorum>(new Action<Yorum>(this.attach_Yorums), new Action<Yorum>(this.detach_Yorums));
			this._AltKategori = default(EntityRef<AltKategori>);
			this._Resim = default(EntityRef<Resim>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_KisaAciklama", DbType="NVarChar(500)")]
		public string KisaAciklama
		{
			get
			{
				return this._KisaAciklama;
			}
			set
			{
				if ((this._KisaAciklama != value))
				{
					this.OnKisaAciklamaChanging(value);
					this.SendPropertyChanging();
					this._KisaAciklama = value;
					this.SendPropertyChanged("KisaAciklama");
					this.OnKisaAciklamaChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Icerik", DbType="NVarChar(4000)")]
		public string Icerik
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EklenmeTarihi", DbType="Date")]
		public System.Nullable<System.DateTime> EklenmeTarihi
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Yazar", DbType="NVarChar(256)")]
		public string Yazar
		{
			get
			{
		...
		public System.Nullable<int> KategoriID
		{
			...
			set
			{
				...
				{
					if (this._AltKategori.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ResımID", DbType="Int")]
		public System.Nullable<int> ResımID
		{
			get
			{
				return this._ResımID;
			}
			set
			{
				if ((this._ResımID != value))
				{
					if (this._Resim.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnResımIDChanging(value);
					this.SendPropertyChanging();
					this._ResımID = value;
					this.SendPropertyChanged("ResımID");
					this.OnResımIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Haber_Yorum", Storage="_Yorums", ThisKey="id", OtherKey="HaberID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AltKategori_Haber", Storage="_AltKategori", ThisKey="KategoriID", OtherKey="id", IsForeignKey=true)]
		public AltKategori AltKategori
		{
			get
			{
				return this._AltKategori.Entity;
			}
			set
			{
				AltKategori previousValue = this._AltKategori.Entity;
				if (((previousValue != value) 
							|| (this._AltKategori.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._AltKategori.Entity = null;
						previousValue.Habers.Remove(this);
					}
					this._AltKategori.Entity = value;
					if ((value != null))
					{
						value.Habers.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Resim_Haber", Storage="_Resim", ThisKey="ResımID", OtherKey="id", IsForeignKey=true)]
		public Resim Resim
		{
			get
			{
				return this._Resim.Entity;
			}
			set
			{
				Resim previousValue = this._Resim.Entity;
				if (((previousValue != value) 
							|| (this._Resim.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Resim.Entity = null;
						previousValue.Habers.Remove(this);
					}
					this._Resim.Entity = value;
					if ((value != null))
					{
						value.Habers.Add(this);
						this._ResımID = value.id;
					}
					else
					{
						this._ResımID = default(Nullable<int>);
					}
